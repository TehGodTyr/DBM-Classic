...
L.LOAD_MOD_TOC_MISMATCH		= "%s|1은;는; WoW 클래식 시대용으로 제작된 것이 아니라서 로딩할 수 없습니다. 최신 확장팩이나 불타는 성전 클래식 버전 모듈을 설치한 것 같습니다. 해당 모듈은 삭제하시고 WoW 클래식 시대용으로 제작된 애드온만 사용하세요."
...
L.CLASSIC_ONLY					= "경고: 이 " .. L.DBM .. "은 WoW: 클래식 시대 전용입니다. 삭제하시고 현재 이용중인 WoW 버전에 맞는 " .. L.DBM .. "을 설치하세요."
